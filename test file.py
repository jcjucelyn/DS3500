...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.P('Adjust Cycle Length', style={'fontFamily': 'Baskerville'}),
            dcc.Slider(id='cycle_tune', min=1, max=20, step=1, value=11, tooltip={'placement': 'bottom'}),

            html.P('Adjust Months', style={'fontFamily': 'Baskerville', 'display': 'inline-block'}),
            dcc.RangeSlider(1, 12, 1, marks={
                ...
                12: 'Dec',
                        ...
                        value=[2, 5], id='month_selector')], style={'display': 'inline-block'})]),
